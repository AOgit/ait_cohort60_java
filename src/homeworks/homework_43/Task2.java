...
public class Task2 {
    ...
    public static void main(String[] args) {
        ...
        int[] arrAddIndex = new int[20_000];
        ...
        int[] arrRemoveIndex = new int[10_000];
        Arrays.setAll(arrRemoveIndex,  i -> random.nextInt(arrList.size() - 10_000));
        ...
        Arrays.setAll(arrRemoveValue,  i -> random.nextInt( 10_001));
